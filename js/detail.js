...
ptitle.textContent = data[pageIndex].title;
const pprice = document.querySelector("#product-price");
pprice.textContent = "$" + data[pageIndex].price;
const pimg = document.querySelector("#product-image");
pimg.setAttribute("src", data[pageIndex].imgURL);
const em = document.querySelector("em");
em.textContent = data[pageIndex].caption;
const article = document.querySelector("article");
article.textContent = data[pageIndex].description;
